    ...
    template: `
      <main style="min-height: 100vh; padding: 3rem; display: grid; place-items: center; background: #050816; color: #edf2ff; font-family: Inter, sans-serif;">
        <section style="max-width: 56rem; width: 100%;">
          ...
          <h1 style="margin: 0; font-family: var(--nc-font-heading, Michroma, sans-serif); font-size: var(--nc-font-size-h1, 2.75rem); line-height: .95; letter-spacing: -.05em; color: var(--nc-color-heading, #fb15cc);">
