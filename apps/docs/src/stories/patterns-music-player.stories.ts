...
# Playground
Use the canvas controls to play, pause, stop, mute, and scrub the track. Story controls also let you seed playback state, mute state, and seek position for demos and review.

# Accessibility
- Native button semantics for primary playback actions.
- Keyboard-accessible range input for scrubbing.
- Visible focus treatments using Nightcall focus and glow tokens.
- Live status announcements for screen readers during play, pause, mute, stop, and seek events.
